...
export function Tree() {
  ...
  const bgColor = new THREE.Color(0xd7d7d7);
  ...
  dofFolder.add(effectController, 'aperture', 0, 0.002, 0.00001).onChange(() => {
